...
class MyGame(arcade.Window):
   ...
   """
    ...
    def draw_instructions(self):
        """
        Dépendamment de l'état de jeu, afficher les instructions d'utilisation au joueur (appuyer sur espace,
        ou sur une image)
        """
        pass
    ...
    def on_draw(self):
       ...
       """
        ...
        # Cette commande permet d'effacer l'écran avant de dessiner. Elle va dessiner l'arrière-plan selon la couleur
        # spécifiée avec la méthode "set_background_color".
        arcade.start_render()
